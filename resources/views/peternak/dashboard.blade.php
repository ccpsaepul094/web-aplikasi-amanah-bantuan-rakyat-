...
@section('title', 'Dashboard - peternak SABAR')
                                ...
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            ...
                                            <p class="mb-0 text-sm text-gray-600">Petarnak</p>
                                        </div>
...
<div class="row">
                <div class="col-6 col-lg-3 col-md-6">
                    ...
                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                        <h6 class="text-muted font-semibold">Jumlah Ternak</h6>
                        <h6 class="font-extrabold mb-0">{{ number_format($jumlahTernak) }}  Ekor</h6>                    </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start ">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Bagi Hasil</h6>
                                        <h6 class="font-extrabold mb-0">{{ $jumlahBagiHasil }} Ekor</h6>
                                    </div>
            ...
            @include('peternak.includes.footer')
